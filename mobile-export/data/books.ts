 ...
 * Generated by `node scripts/src/bake-demo-images.mjs`.
 * Missing entries fall back to gradient backgrounds.
 */
export const SCENE_IMAGES: Record<string, number> = {
  "alice-ch1-s1": require("../assets/images/scenes/alice-ch1-s1.png"),
  "alice-ch1-s2": require("../assets/images/scenes/alice-ch1-s2.png"),
  "alice-ch1-s3": require("../assets/images/scenes/alice-ch1-s3.png"),
  "alice-ch1-s4": require("../assets/images/scenes/alice-ch1-s4.png"),
  "alice-ch1-s5": require("../assets/images/scenes/alice-ch1-s5.png"),
  "alice-ch1-s6": require("../assets/images/scenes/alice-ch1-s6.png"),
  "dracula-ch1-s1": require("../assets/images/scenes/dracula-ch1-s1.png"),
  "dracula-ch1-s2": require("../assets/images/scenes/dracula-ch1-s2.png"),
  "dracula-ch1-s3": require("../assets/images/scenes/dracula-ch1-s3.png"),
  "frank-ch1-s1": require("../assets/images/scenes/frank-ch1-s1.png"),
  "frank-ch1-s2": require("../assets/images/scenes/frank-ch1-s2.png"),
  "frank-ch1-s3": require("../assets/images/scenes/frank-ch1-s3.png"),
  "sherlock-ch1-s1": require("../assets/images/scenes/sherlock-ch1-s1.png"),
  "sherlock-ch1-s2": require("../assets/images/scenes/sherlock-ch1-s2.png"),
  "sherlock-ch1-s3": require("../assets/images/scenes/sherlock-ch1-s3.png"),
};
